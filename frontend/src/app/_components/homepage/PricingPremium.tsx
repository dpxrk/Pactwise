              ...
              >
                ...
                {plan.popular && (
                  <div className="absolute -top-4 left-0 right-0 flex justify-center z-10">
                    <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm font-semibold px-4 py-1 rounded-full shadow-glow">
                      Most Popular
                    </div>
                  </div>
                )}
                ...
                `}>
                  ...
                  {/* Card content */}
                  <div className={`
                    relative h-full glass rounded-3xl p-6
                    ${plan.popular
                    ...
                    {isEnterprise ? (
                      ...
                      <CheckoutButton
                        ...
                        className={`
                          ...
                          transition-all duration-300 group
                          ${plan.popular
                            ? "bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:from-purple-700 hover:to-pink-700 shadow-glow"
                            : "glass text-white hover:bg-white/10 border border-white/10 hover:border-white/20"
                          }
                        `}
                      >
