...
describe('PricingCard Component', () => {
  ...
  describe('Discount Code Functionality', () => {
    ...
    it('should apply valid discount code PARTNER20', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('$399')).toBeInTheDocument(); // 499 - 20% = 399
  ...
  describe('Price Display', () => {
    ...
    it('should calculate correct discounted prices', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('$424')).toBeInTheDocument(); // 499 - 15% = 424
      });
    });
  });
  ...
  describe('Accessibility', () => {
    ...
    it('should be keyboard navigable', async () => {
      ...
      await user.tab();
      expect(screen.getByLabelText('Apply discount code')).toHaveFocus();
