...
-- Description: Comprehensive function to get all dashboard statistics in a single call
-- Author: System
-- Date: 2025-01-XX
...
-- Add comment
COMMENT ON FUNCTION get_dashboard_stats(UUID) IS 'Returns comprehensive dashboard statistics for an enterprise including contracts, vendors, agents, compliance, and financial metrics';
